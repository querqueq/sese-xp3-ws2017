...
public class ReceiptServiceTest extends HotelManagementApplicationTests {
   ...
   */
  @Test
  public void getAllReceipts_fullDB() throws Exception {
    // Define expected result
    ReceiptEntity[] expectedResult = new ReceiptEntity[]{
        TestDataInjector.RECEIPT_1, TestDataInjector.RECEIPT_2, TestDataInjector.RECEIPT_3,
        TestDataInjector.RECEIPT_4, TestDataInjector.RECEIPT_5, TestDataInjector.RECEIPT_6
    };
    // Execute service function
    List<ReceiptEntity> allReceiptsByCriteria = receiptService.getAllReceipts();
  ...
  /**
   * Find all receipts by providing no criteria
   */
  @Test
  public void getAllReceiptsByCriteria_noCriteria() throws Exception {
    // Define expected result
    ReceiptEntity[] expectedResult = new ReceiptEntity[]{
        TestDataInjector.RECEIPT_1, TestDataInjector.RECEIPT_2,
        TestDataInjector.RECEIPT_3, TestDataInjector.RECEIPT_4,
   ...
   */
  @Test
  public void getAllReceiptsByCriteria_DateRange() throws Exception {
    // Define expected result
    ReceiptEntity[] expectedResult = new ReceiptEntity[]{
    ...
    // Execute service function
    List<ReceiptEntity> allReceiptsByCriteria = receiptService
        .getAllReceiptsByCriteria(new Date(1507327200000L), new Date(1508191200000L),
            null,
            null, null,
            null, null,
            null, null,
  ...
  /**
   * Find only receipts until the 12th of October 2017.
   *
   * <p>
   *   Should return only receipts 1, 4, 5 and 6
   * </p>
   */
  @Test
  public void getAllReceiptsByCriteria_DateRangeOpenDownwards() throws Exception {
    // Define expected result
    ReceiptEntity[] expectedResult = new ReceiptEntity[]{
    ...
    // Execute service function
    List<ReceiptEntity> allReceiptsByCriteria = receiptService
        .getAllReceiptsByCriteria(null, new Date(1507759200000L),
            null,
            null, null,
            null, null,
            null, null,
  ...
  /**
   * Find only receipts since the 7th of October 2017.
   *
   * <p>
   *   Should return only receipts 1, 2, 3 and 4
   * </p>
   */
  @Test
  public void getAllReceiptsByCriteria_DateRangeOpenUpwards() throws Exception {
    // Define expected result
    ReceiptEntity[] expectedResult = new ReceiptEntity[]{
        TestDataInjector.RECEIPT_1, TestDataInjector.RECEIPT_2,
        TestDataInjector.RECEIPT_3, TestDataInjector.RECEIPT_4
    ...
    // Execute service function
    List<ReceiptEntity> allReceiptsByCriteria = receiptService
        .getAllReceiptsByCriteria(new Date(1507327200000L), null,
            null,
            null, null,
            null, null,
            null, null,
